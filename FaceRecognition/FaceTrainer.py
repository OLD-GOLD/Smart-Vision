...
# In line below, you need to specify the location of the file
detector = cv2.CascadeClassifier("D:\Software app development\Python projects\projectAssets\haarcascade_frontalface_default.xml")
...
# In line below, you need to specify the location of the file
recognizer.write('D:\Software app development\Python projects\FaceRecognition\ trainer.yml')
